...
(cl:defmethod name-val ((m <Patrol-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtle_patrol-srv:name-val is deprecated.  Use turtle_patrol-srv:name instead.")
  (name m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Patrol-request>)))
  ...
  "9a8234b12d4d5f7b0bfa24e419aa9718")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Patrol-request)))
  "Returns md5sum for a message object of type 'Patrol-request"
  "9a8234b12d4d5f7b0bfa24e419aa9718")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Patrol-request>)))
  ...
  (cl:format cl:nil "# Request message types~%float32 vel~%float32 omega~%float32 x~%float32 y~%float32 theta~%string name~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Patrol-request)))
  "Returns full string definition for message of type 'Patrol-request"
  (cl:format cl:nil "# Request message types~%float32 vel~%float32 omega~%float32 x~%float32 y~%float32 theta~%string name~%~%~%"))
