...
def main():
    ...
    # size = np.array([0.4, 1.2, 0.1]).reshape((3,1))  # x, y, z
    # pose = PoseStamped()
    ...
    # planner.add_box_obstacle(size=size, name="box", pose=pose)
